...
class BaseConfig:
    ...
    CODEGEN_FILE = os.path.join(GUI_FLASK_PATH, '../cquirrel_flask/jar/codegen.jar')
    CODEGEN_LOG_PATH = os.path.join(GUI_FLASK_PATH, '../cquirrel_flask/log')
    CODEGEN_LOG_FILE = os.path.join(GUI_FLASK_PATH, '../cquirrel_flask/log/codegen.log')
    TEST_RESOURCES_PATH = os.path.join(GUI_FLASK_PATH, '../cquirrel_flask/tests/resources')
    ...
    INPUT_DATA_FILE = os.path.join(GUI_FLASK_PATH, 'cquirrel_app/resources/input_data_q10_0.1_sliding_window.csv')
