...
object Job {
   ...
   private def getStream(env: StreamExecutionEnvironment, dataPath: String): DataStream[Payload] = {
      ...
      header match {
         ...
         action = "Insert"
         relation = "lineitem"
         val i = Tuple6(cells(8),cells(5).toDouble,cells(6).toDouble,cells(3).toInt,cells(0).toLong,cells(15))
         cnt = cnt + 1
         ctx.output(lineitemTag, Payload(relation, action, cells(0).toLong.asInstanceOf[Any],
         Array[Any](i._1,i._2,i._3,i._4,i._5,i._6),
         Array[String]("RETURNFLAG","EXTENDEDPRICE","DISCOUNT","LINENUMBER","ORDERKEY","L_COMMENT"), cnt))
         case "-LI" =>
         action = "Delete"
         relation = "lineitem"
         val i = Tuple6(cells(8),cells(5).toDouble,cells(6).toDouble,cells(3).toInt,cells(0).toLong,cells(15))
         ...
         action = "Insert"
         relation = "orders"
         val i = Tuple4(format.parse(cells(4)),cells(1).toLong,cells(0).toLong,cells(8))
         cnt = cnt + 1
         ctx.output(ordersTag, Payload(relation, action, cells(1).toLong.asInstanceOf[Any],
         Array[Any](i._1,i._2,i._3,i._4),
         Array[String]("ORDERDATE","CUSTKEY","ORDERKEY","O_COMMENT"), cnt))
         case "-OR" =>
         action = "Delete"
         relation = "orders"
         val i = Tuple4(format.parse(cells(4)),cells(1).toLong,cells(0).toLong,cells(8))
