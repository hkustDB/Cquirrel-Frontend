...
object Job {
   ...
   def main(args: Array[String]) {
      ...
      val inputpath = "file:///Users/chaoqi/Projects/AJU/code/gui-codegen/gui/cquirrel_flask/cquirrel_app/resources/input_data_q10_insert_only.csv"
      val outputpath = "file:///Users/chaoqi/Projects/AJU/code/gui-codegen/gui/cquirrel_flask/cquirrel_app/resources/output_data.csv"
      ...
      .process(new QnationProcessFunction())
      val customerS = nationS.connect(customer)
      .keyBy(i => i._3, i => i._3)
      .process(new QcustomerProcessFunction())
      val ordersS = customerS.connect(orders)
      .keyBy(i => i._3, i => i._3)
      .process(new QordersProcessFunction())
      val lineitemS = ordersS.connect(lineitem)
      .keyBy(i => i._3, i => i._3)
      .process(new QlineitemProcessFunction())
      val result = lineitemS.keyBy(i => i._3)
      .process(new QAggregate0ProcessFunction())
   ...
   private def getStream(env: StreamExecutionEnvironment, dataPath: String): DataStream[Payload] = {
      ...
      header match {
         ...
         action = "Insert"
         relation = "lineitem"
         val i = Tuple6(cells(0).toLong,cells(6).toDouble,cells(8),cells(5).toDouble,cells(3).toInt,cells(15))
         cnt = cnt + 1
         ctx.output(lineitemTag, Payload(relation, action, cells(0).toLong.asInstanceOf[Any],
         Array[Any](i._1,i._2,i._3,i._4,i._5,i._6),
         Array[String]("ORDERKEY","L_DISCOUNT","L_RETURNFLAG","L_EXTENDEDPRICE","LINENUMBER","L_COMMENT"), cnt))
         case "-LI" =>
         action = "Delete"
         relation = "lineitem"
         val i = Tuple6(cells(0).toLong,cells(6).toDouble,cells(8),cells(5).toDouble,cells(3).toInt,cells(15))
         ...
         action = "Insert"
         relation = "orders"
         val i = Tuple4(format.parse(cells(4)),cells(0).toLong,cells(1).toLong,cells(8))
         cnt = cnt + 1
         ctx.output(ordersTag, Payload(relation, action, cells(1).toLong.asInstanceOf[Any],
         Array[Any](i._1,i._2,i._3,i._4),
         Array[String]("O_ORDERDATE","ORDERKEY","CUSTKEY","O_COMMENT"), cnt))
         case "-OR" =>
         action = "Delete"
         relation = "orders"
         val i = Tuple4(format.parse(cells(4)),cells(0).toLong,cells(1).toLong,cells(8))
